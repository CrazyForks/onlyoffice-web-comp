...
本项目**不包含**受版权保护的商业字体文件。字体名称保留在配置中以兼容文档，实际字体文件需自行添加。步骤见 [06-注意事项](src/components/onlyoffice-web-comp/docs/06-注意事项与支持格式.md) 或按 `public/sdkjs/common/AllFonts.js` 中的索引放置到 `public/fonts/`。
