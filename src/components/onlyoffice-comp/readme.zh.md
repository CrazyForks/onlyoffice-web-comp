...
1. **静态资源**：将 OnlyOffice SDK（含 `web-apps/`、`sdkjs/`、`fonts/`、`x2t-1/`）放到站点可访问目录，默认 `public/v9.3.0.24-1/`。
2. **环境变量**（可选）：`NEXT_PUBLIC_APP_ROOT=/v9.3.0.24-1`，与 `STATIC_RESOURCE.onlyoffice.root` 一致。
